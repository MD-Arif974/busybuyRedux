...
const Navbar = () => {
  ...
  const {userClicked} = useSelector(homeSelector);
  const dispatch = useDispatch();
  let auth = sessionStorage.getItem("email");


  /* getName method is used to get the name of the user after sign in
     here i am fetching name bcoz if i am at other page if i refresh the name will be lost
  ...
  */
  ...
  // handleLogOut method is used to logout the user
  const handleLogOut = (e) => {
    try {
      sessionStorage.removeItem("email");
      dispatch(authActions.logout());
      dispatch(homeActions.showLogOutButton(false));
  ...
  return (
    <>
      <div className={styles.navCont}>
        ...
        <Link to="/">
          <div className={`${auth ? styles.home : styles.homeNotSignin}`} onClick={() => dispatch(homeActions.showLogOutButton(false))}>
        ...
        
        {
          userClicked ?
          <Link to="/">
          <div className={styles.logout} onClick={(e) => handleLogOut(e)}>
            <img
        ...
        {auth ? (
          <>
            <Link to="/order">
              <div className={styles.order} onClick={() => dispatch(homeActions.showLogOutButton(false))}>
                <img
            ...
            <Link to="/cart">
              <div className={styles.cart} onClick={() => dispatch(homeActions.showLogOutButton(false))}>
                <img
        ...
        {auth ? (
          <div className={styles.userName} onClick={() => dispatch(homeActions.showLogOutButton())}>
            <img
